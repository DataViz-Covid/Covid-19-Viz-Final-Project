function drawChart_v7() {
    ...
    d3.csv("/Final-Project/data_clean/viz7.csv", function(d){
    ...
    d3.csv("/Final-Project/data_clean/viz7_cont.csv", function(d){
    ...
    d3.csv("/Final-Project/data_clean/viz7_world.csv", function(d){
